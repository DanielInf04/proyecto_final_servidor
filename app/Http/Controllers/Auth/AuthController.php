    ...
    public function register(Request $request) {
        ...
        if ($request->role === 'cliente') {
            ...
            /*Empresa::create([
                ...
                'telefono' => $request->input('empresa.telefono'),
                'direccion' => $request->input('empresa.direccion'),
                'descripcion' => $request->input('empresa.descripcion'),
                'nif' => $request->input('empresa.nif'),
            ]);*/
            $empresa = new Empresa;
