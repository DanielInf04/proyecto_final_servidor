...
class AuthController extends Controller
{
    ...
    public function register(Request $request) {
        $validator = Validator::make(request()->all(), [
            ...
            'cliente.telefono' => 'required_if:role,cliente',
            'empresa.nombre' => 'required_if:role,empresa',
            'empresa.telefono' => 'required_if:role,empresa',
            'empresa.direccion' => 'required_if:role,empresa',
            'empresa.descripcion' => 'required_if:role,empresa',
            'empresa.nif' => 'required_if:role,empresa',
